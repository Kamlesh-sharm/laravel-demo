    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('vendor.rooms_management.rooms') }}">
        ...
        <div class="card-body pt-5 pb-5">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="roomForm" action="{{ route('vendor.rooms_management.store_room') }}" method="POST">
                @csrf
