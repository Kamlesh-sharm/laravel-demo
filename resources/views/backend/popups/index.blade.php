                ...
                <div class="row">
                  <div class="col-12 text-center">
                    <div class="alert alert-warning text-dark">
                      ...
                      {{ __('will be shown in website according to') }} <strong
                        class="text-info">{{ __('Serial Number') }}</strong>
                    </div>
                  </div>
                </div>
                    ...
                    <tbody>
                      @foreach ($popups as $key => $popup)
                        <tr>
                          ...
                          <td>
                            <div class="mb-2">
                              @if (!empty($popup->image))
                                <img src="{{ asset('assets/img/popups/' . $popup->image) }}" width="65">
                              @elseif (!empty($popup->background_image))
                                <img src="{{ asset('assets/img/popups/' . $popup->background_image) }}" width="65">
                              @endif
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <img width="60"
                              src="{{ asset('assets/img/admins/popups/popup-' . $popup->type . '.jpg') }}">
                            <p class="mb-0">
                              {{ __('Type') }} - {{ $popup->type }}
                            </p>
                          </td>
                          ...
                          <td>
                            <a class="btn btn-secondary mb-1 btn-sm"
