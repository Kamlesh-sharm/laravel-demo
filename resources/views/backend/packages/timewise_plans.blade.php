        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-lg-5 mt-2 mt-lg-0">
              ...
              <a href="#" class="btn btn-primary btn-sm mr-1 planBtn float-lg-right float-left" data-id="{{ $package->id }}" data-plan_type="{{ $package->plan_type }}">{{ __('Add Plan') }}</a>
              <button
                class="btn btn-danger btn-sm float-right mr-1 d-none bulk-delete"
                        ...
                        <tr>
                          ...
                          <td>
                            <a
                              ...
                              data-edit_plan="{{ replaceBaseUrl($plan->plan, 'summernote') }}"
                            >
