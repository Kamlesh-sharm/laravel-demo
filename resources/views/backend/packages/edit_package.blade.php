      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-md-6">
              <a class="btn btn-info btn-sm float-lg-right ml-sm-1 float-left d-inline-block"
              ...
              <a class="btn btn-success btn-sm float-lg-right float-right d-inline-block mr-2" target="_blank"
        ...
        <div class="card-body pt-5 pb-5">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="packageForm"
                action="{{ route('admin.packages_management.update_package', ['id' => $package->id]) }}" method="POST">
                @csrf
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="vendor_id">
                        ...
                        @foreach ($vendors as $item)
                          <option value="{{ $item->id }}" {{ $package->vendor_id == $item->id ? 'selected' : '' }}>
...
@section('script')
  ...
  <script>
    ...
    var rmvdbUrl = "{{ route('admin.packages_management.imgdbrmv') }}";
    var packageLoadImgs = "{{ route('admin.packages_management.images', $package->id) }}";
  </script>
