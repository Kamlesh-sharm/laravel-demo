            ...
            <div class="col-lg-12">
              <div class="row">
                <div class="col-lg-12">
                  ...
                  @if ($ticket->status != 3)
                    <form id="closeForm" class="d-block" action="{{ route('admin.support_ticket.close', $ticket->id) }}"
                      method="post">
                ...
                <div class="col-lg-8 offset-lg-2">
                  ...
                  @if ($ticket->attachment)
                    @if ($ticket->user_type == 'customer')
                      <a href="{{ asset('assets/img/support-ticket/' . $ticket->attachment) }}"
                ...
                @foreach ($ticket->messages as $reply)
                  @if ($reply->type == 2)
                    ...
                    <div class="item-list">
                      <div class="avatar">
                        <img
                          src="{{ $admin->image ? asset('assets/img/admins/' . $admin->image) : asset('assets/img/blank_user.jpg') }}"
                      ...
                      <div class="info-user ml-3">
                        ...
                        <p>{!! $reply->reply !!}</p>
                        @if ($reply->file)
                          <a href="{{ asset('assets/img/support-ticket/' . $reply->file) }}" download="support_file"
                            class="btn btn-rounded btn-info btn-sm">{{ __('Download') }}</a>
                        @endif
                      </div>
                    </div>
                  @else
