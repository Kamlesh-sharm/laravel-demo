          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <form action="" class="" method="GET">
                <input type="text" name="ticket_id" class="form-control float-lg-right float-none min-w-250"
            ...
            <div class="col-lg-4 mt-2 mt-lg-0">
              <button class="btn btn-danger float-lg-right float-none mb-1 btn-sm mt-1 bulk-delete d-none"
                        ...
                        <tr>
                          ...
                          <td>
                            @if ($item->user_type == 'vendor')
                              @if ($item->vendor)
                                <a
                                  href="{{ route('admin.vendor_management.vendor_details', ['id' => @$item->vendor->id, 'language' => $defaultLang->code]) }}">{{ @$item->vendor->username }}</a>
                              @else
                                -
                              @endif
                            @else
                              @if ($item->user)
                                <a
                                  href="{{ route('register.user.view', ['id' => @$item->user->id, 'language' => $defaultLang->code]) }}">{{ @$item->user->username }}</a>
                              @else
                                -
                              @endif
                            @endif
