            ...
            <div class="row">
              <div class="col-lg-6 mx-auto">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <div class="custom-control custom-checkbox vendor_admin_approvalbtn">
                        ...
                        <label class="custom-control-label" for="vendor_admin_approval">{{ __('Needs Admin Approval') }}</label>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-12 {{ $setting->vendor_admin_approval == 0 ? 'd-none' : '' }} admin_approval_notice">
                    <div class="form-group">
