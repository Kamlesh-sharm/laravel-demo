...
@section('content')
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="#" class="btn btn-primary float-right" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> {{ __('Add Role') }}</a>
        </div>
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
                    ...
                    <tbody>
                      @foreach ($roles as $key => $role)
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mb-1 editBtn mr-1" href="#editModal" data-toggle="modal" data-role_id="{{$role->id}}" data-name="{{$role->name}}">
                              <span class="btn-label">
                                <i class="fas fa-edit"></i>
                              </span>
                            </a>
  ...
  <!-- Create Roles Modal -->
  @includeif('backend.role.create')

  <!-- Edit Roles Modal -->
  @includeif('backend.role.edit')
