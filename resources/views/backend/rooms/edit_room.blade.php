        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              @endphp
              @if ($dRoomContent)
                <a class="btn btn-success btn-sm float-lg-right float-right mr-1 d-inline-block" target="_blank"
        ...
        <div class="card-body pt-5 pb-5">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="roomForm" action="{{ route('admin.rooms_management.update_room', ['id' => $room->id]) }}"
                method="POST">
                @csrf
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="vendor_id">
                        ...
                        @foreach ($vendors as $item)
                          <option value="{{ $item->id }}" {{ $room->vendor_id == $item->id ? 'selected' : '' }}>
...
@section('script')
  ...
  <script>
    ...
    var rmvdbUrl = "{{ route('admin.rooms_management.imgdbrmv') }}";
    var loadImgs = "{{ route('admin.rooms_management.images', $room->id) }}";
  </script>
