      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-md-6 ">
              <a href="#" class="btn btn-sm btn-primary mb-1 mr-1 float-lg-right float-left" data-toggle="modal"
                data-target="#createModal"><i class="fas fa-plus"></i> {{ __('Add Language') }}</a>
                    ...
                    <tbody>
                      @foreach ($languages as $language)
                        <tr>
                          ...
                          <td>
                            <a href="#" class="btn btn-secondary mb-1 btn-sm mr-1 editBtn" data-toggle="modal"
                            ...
                            <a class="btn btn-info btn-sm mb-1 mr-1"
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.languages.delete_language', $language->id) }}" method="post">
                              @csrf
