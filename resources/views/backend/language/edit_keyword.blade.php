    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('admin.languages') }}">
          ...
          <div class="row">
            <div class="col-lg-12">
              <form id="languageKeywordForm"
                action="{{ route('admin.languages.update_keyword', ['id' => $language->id]) }}" method="post">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-4 mt-2">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input class="form-control form-control-lg" type="text" name="keyValues[{{ $keyword }}]"
                            value="{{ $value }}">
                        </div>
                      </div>
                    </div>
